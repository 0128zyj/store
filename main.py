...
print("----------------------------------------------------------------------------")
sum = float('%.2f'%(253.6*(10+69+140+10+10)+135.9*(63+24+63+57)+86.3*(60+72+35+90+60+60+140)+96.8*(43+25+43+60+43+78)+49.3*120+65.8*(63+45+129+63+58+48+63)))
print("12月份销售总金额:", sum)

yrf = 253.6*(10+69+140+10+10)
pc = 135.9*(63+24+63+57)
nzk = 86.3*(60+72+35+90+60+60+140)
fy = 96.8*(43+25+43+60+43+78)
cs = 49.3*120
Tx = 65.8*(63+45+129+63+58+48+63)

print("每件衣服的销售占比:")
print("羽绒服:", f"{yrf/sum*100:.2f}","%")
print("皮草:", f"{pc/sum*100:.2f}","%")
print("牛仔裤:", f"{nzk/sum*100:.2f}","%")
print("风衣:", f"{fy/sum*100:.2f}","%")
print("衬衫:", f"{cs/sum*100:.2f}","%")
print("T恤:", f"{Tx/sum*100:.2f}","%")